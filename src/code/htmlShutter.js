...
export class htmlShutter{
  ...
  defStyleVarsShutter(){
    ...
    return `
      --mdc-icon-button-size: ${this.cfg.controlButtonBoxPx ? this.cfg.controlButtonBoxPx() : this.cfg.iconButtonSize()}${C.UNITY};
      --ha-icon-button-size: ${this.cfg.controlButtonBoxPx ? this.cfg.controlButtonBoxPx() : this.cfg.iconButtonSize()}${C.UNITY};
